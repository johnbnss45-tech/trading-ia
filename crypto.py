...
CRYPTOS_SERIEUSES = {
    "ETHUSDC", "BNBUSDC", "SOLUSDC", "XRPUSDC",
    "ADAUSDC", "AVAXUSDC", "DOTUSDC", "LINKUSDC",
    "LTCUSDC", "UNIUSDC", "ATOMUSDC", "NEARUSDC",
    "APTUSDC", "ARBUSDC", "OPUSDC", "INJUSDC",
    "SUIUSDC", "FETUSDC", "RENDERUSDC", "STXUSDC",
    "RUNEUSDC", "AAVEUSDC", "MKRUSDC"
}
